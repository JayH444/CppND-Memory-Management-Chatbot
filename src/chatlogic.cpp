...
// Credits to Justin S / JSheldon3488 for their questions and solutions in the udacity knowledgebase + their github for helping me with tasks 3 thru 5.
// September 2020, https://knowledge.udacity.com/questions/76200, https://github.com/JSheldon3488/Udacity_Chatbot
...
ChatLogic::~ChatLogic()
{
    ...
    /*  
    // No longer necessary since ChatLogic now maintains no ownership relation to the chatbot instance,
    // and thus has no need to handle its allocation/deallocation.
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot rootNodeChatBot = ChatBot("../images/chatbot.png");
    rootNodeChatBot.SetChatLogicHandle(this);
    rootNodeChatBot.SetRootNode(rootNode);
    rootNode->MoveChatbotHere(std::move(rootNodeChatBot));
